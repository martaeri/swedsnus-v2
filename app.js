(() => {
  ...
  ['ui-components.css','product-images.css','developer-log.css','mobile.css','ux-refinements.css','mobile-filter-pills.css','nicotine-warning.css'].forEach(href => {
  ...
  async function start() {
    ...
    if(document.body.dataset.page==='portion') await load('portion-format-pills.js');
